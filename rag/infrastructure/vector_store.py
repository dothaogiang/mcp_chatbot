"""
infrastructure/vector_store.py — Adapter thao tác Qdrant.

2 collection:
  - "archives"        : 1 point = 1 hồ sơ (metadata) -> search_profile
  - "document_chunks" : 1 point = 1 đoạn text trích từ PDF ->
